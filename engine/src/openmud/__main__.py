...
from openmud.pack import load_pack, reattach_pack_manifest
...
from openmud.scenes import DEFAULT_SCENE_PATH, build_world
...
def _parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(prog="openmud")
    parser.add_argument(
        "--pack",
        metavar="PATH",
        type=Path,
