...
from openmud.commands import execute, resolve_verb
...
from openmud.lookup import find_reachable_container, iter_lookable_containers
from openmud.matching import (
    Ambiguous,
    Candidate,
    EntityCandidate,
    IndexOutOfRange,
...
class DeterministicParser(Parser):
    ...
    def _direction_candidates(
        ...
        from openmud.components import HiddenExits
