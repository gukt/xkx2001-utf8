...
from openmud.capabilities import (
    CAPABILITIES,
    NPC_CAPABILITIES,
    ROOM_CAPABILITIES,
    CapabilitySpec,
...
from openmud.death_flow import parse_death_policy, parse_loot_table
from openmud.errors import SceneLoadError
from openmud.factions import FACTIONS, load_factions_from_mapping, replace_factions_registry
from openmud.library import parse_book_catalog, resolve_library_books
from openmud.quest import QuestDef
from openmud.runtime import wire_runtime
from openmud.semantic_color import validate_markup
from openmud.skills import load_skills_from_mapping, replace_skills_registry
from openmud.world import EntityId, World

# ``SceneLoadError`` 规范在 ``openmud.errors``；本模块再导出以保持
# ``from openmud.scene_loader import SceneLoadError`` 向后兼容。
...
def _attach_room_hook_binding(
    ...
    *,
    ...
    from openmud.room_hooks import get_room_hook
