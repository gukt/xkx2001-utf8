...
class TestCpkLoader:
    ...
    def test_load_xueshan_micro(self) -> None:
        ...
        r = default_registry()
        m, ir, rules = load_cpk(SCENES / "xueshan_micro", registry=r)
    ...
    def test_load_all_5_micro_scenes(
        ...
        r = default_registry()
        m, ir, rules = load_cpk(SCENES / name, registry=r)
    ...
    def test_no_registry_skips_theme_check(self) -> None:
        ...
        m, ir, rules = load_cpk(SCENES / "academy_micro")
