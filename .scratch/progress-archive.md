...
- [x] **Polishing Wave 5 落地：条件 DSL 文档 + 液体/eat/drink**（2026-07-23）：票 `07`/`08`；`docs/condition-dsl.md`；`RoomResources`/`LiquidContainer`；`fill`/`drink`/`eat`；fixed point `polishing-wave5-start`；935 绿。
