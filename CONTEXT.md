...
**剧情门**:
相对标准门锁的声明式扩展：可耗钥、未开无向、NPC 在场挡向。房间保真批验收以扬州翰林三件套为准。
...
**Pre-M4 房间钩子 / 星宿机制**:
M4 前、房间保真关闭后开工的兄弟 effort：官方可信房间钩子 + `xingxiu_mechanics` 机制验收切片。骨架与 ADR-0012 已落；实现未开。底稿见 `.scratch/pre-m4-room-hooks-xingxiu/`。
