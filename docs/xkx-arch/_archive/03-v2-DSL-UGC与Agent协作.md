...
> 本文档是 v2 创作层方案。与 v1（[03-DSL-UGC与Agent协作](03-DSL-UGC与Agent协作.md)）相比，重点修正：Agent NPC 严格分层、五角色 Worker 降级为能力清单、combat-sim 改真实 `resolve_attack` 纯函数、验证覆盖度六维矩阵、版权清洗与创作者经济 Day1 预留。
