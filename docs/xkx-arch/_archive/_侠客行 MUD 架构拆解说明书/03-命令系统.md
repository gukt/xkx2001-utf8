...
命令系统在整体架构中的位置请参考 [01-架构总览](01-架构总览.md)。
...
- **COMMAND_D**：[02-守护进程系统](02-守护进程系统.md) - 命令查找和缓存
- **SECURITY_D**：[02-守护进程系统](02-守护进程系统.md) - 权限检查
- **EMOTE_D**：[02-守护进程系统](02-守护进程系统.md) - 表情处理
- **CHANNEL_D**：[02-守护进程系统](02-守护进程系统.md) - 频道消息处理
- **ALIAS_D**：[02-守护进程系统](02-守护进程系统.md) - 别名处理

### 7.2 与对象系统的关系

- **Living Object**：[04-对象与继承体系](04-对象与继承体系.md) - 命令的执行者
- **Room Object**：[04-对象与继承体系](04-对象与继承体系.md) - 命令执行环境
- **Item Object**：[04-对象与继承体系](04-对象与继承体系.md) - 命令操作对象

### 7.3 与战斗系统的关系

- **COMBAT_D**：[06-武功与战斗系统](06-武功与战斗系统.md) - `kill`、`fight` 等命令调用

### 7.4 与技能系统的关系

- **skill 命令目录**：[06-武功与战斗系统](06-武功与战斗系统.md) - 技能学习和使用命令
- **perform/exert**：[06-武功与战斗系统](06-武功与战斗系统.md) - 技能绝招调用
